...
class IdiomaService {
  ...
  static const Map<String, Map<String, String>> _textos = {
    ...
    'mitienda_catalog': {
      'es': 'Galería de productos MiTienda',
      'en': 'MyStore Product Gallery',
    },
    'mitienda_catalog_desc': {
      'es': 'Consulta productos disponibles con precio MiTienda.',
      'en': 'View products available with MyStore prices.',
    },
    'price_calculator': {
