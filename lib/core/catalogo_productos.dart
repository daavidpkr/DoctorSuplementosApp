...
const Map<String, String> imagenesProducto4Life = {
  ...
  'Riovida stix': 'assets/productos/productos-ec/riovida_stix.png',
  'Energy go stix': 'assets/productos/productos-ec/energy_go_stix.png',
  'Renuvo': 'assets/productos/productos-ec/renuvo.png',
  'Glucoach': 'assets/productos/productos-ec/glucoach.png',
  'Bcv': 'assets/productos/productos-ec/bcv.png',
  'Malepro': 'assets/productos/productos-ec/malepro.png',
  'Colageno tipo i': 'assets/productos/productos-ec/colageno_tipo_i.png',
  'Transfer factor tri factor':
      'assets/productos/productos-ec/transfer_factor_tri_factor.png',
  'Nutrastart': 'assets/productos/productos-ec/nutrastart.png',
  'Riovida burst': 'assets/productos/productos-ec/riovida_burst.png',
  'Protf': 'assets/productos/productos-ec/protf.png',
  'Bioefa': 'assets/productos/productos-ec/bioefa.png',
  'Belle vie': 'assets/productos/productos-ec/belle_vie.png',
  'Glutamine prime': 'assets/productos/productos-ec/glutamine_prime.png',
  'Kbu': 'assets/productos/productos-ec/kbu.png',
  'Vistari': 'assets/productos/productos-ec/vistari.png',
  'Preo biotics': 'assets/productos/productos-ec/preo_biotics.png',
  'Fibre': 'assets/productos/productos-ec/fibre.png',
  'Agpro': 'assets/productos/productos-ec/agpro.png',
  'Suero': 'assets/productos/productos-ec/suero.png',
  'Crema para los ojos':
      'assets/productos/productos-ec/crema_para_los_ojos.png',
  'Tonico': 'assets/productos/productos-ec/tonico.png',
  'Crema humectante': 'assets/productos/productos-ec/crema_humectante.png',
  'Pasta de dientes': 'assets/productos/productos-ec/pasta_de_dientes.png',
  'Crema cuerpo': 'assets/productos/productos-ec/crema_de_cuerpo.png',
  'Limpiador': 'assets/productos/productos-ec/limpiador.png',
  'Recall': 'assets/productos/productos-ec/recall.png',
  'TF Boost': 'assets/productos/productos-ec/tf_boost.png',
};
