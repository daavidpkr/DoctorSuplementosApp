...
const List<ProductoPrecio> productosConPrecio4Life = [
  ...
  ProductoPrecio(
      ...
      lp: 45, 
      lpCanje: 45),
  ProductoPrecio(nombre: 'Suero', 
      afiliado: 50.31, 
      publico: 66.74, 
      lp: 29),
  ProductoPrecio(
      nombre: 'Crema para los ojos', 
      afiliado: 45.00, 
      publico: 60.00, 
      lp: 27),
  ProductoPrecio(nombre: 'Tonico', 
      afiliado: 36.00, 
      publico: 48.00, 
      lp: 19),
  ProductoPrecio(
  ...
  ProductoPrecio(
      ...
      lp: 42, 
      lpCanje: 42),
  ProductoPrecio(nombre: 'TF Boost', 
      afiliado: 27.72, 
      publico: 36.96, 
      lp: 15),
];
